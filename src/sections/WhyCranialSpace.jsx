...
import { Sparkles, Users, Activity, GraduationCap, Award, Compass, ArrowRight, CheckCircle, Flame, Clock } from 'lucide-react';
  ...
  return (
    <section className="why-section" id="why-us">
      ...
      <div className="why-bento-grid">
        ...
        <motion.div 
          className="bento-card bento-large border-glow-purple"
        ...
        <motion.div 
          className="bento-card bento-medium border-glow-indigo"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
        ...
        <motion.div 
          className="bento-card bento-medium border-glow-sky"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.6, type: "spring", stiffness: 90, damping: 15 }}
        ...
        <motion.div 
          className="bento-card bento-large border-glow-emerald"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.6, delay: 0.1, type: "spring", stiffness: 90, damping: 15 }}
        ...
        <motion.div 
          className="bento-card bento-medium border-glow-rose"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.6, type: "spring", stiffness: 90, damping: 15 }}
        ...
        <motion.div 
          className="bento-card bento-medium border-glow-amber"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.6, delay: 0.1, type: "spring", stiffness: 90, damping: 15 }}
